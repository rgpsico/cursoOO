...
<section class="main-slider">
    ...
    <div class="container">
        ...
        <div class="slidecount">
            ...
            $post = new Read;
            $post->ExeRead("ws_posts", "WHERE post_status = 1 AND (post_cat_parent = :cat OR post_category = :cat)
			ORDER BY post_date DESC LIMIT :limit OFFSET :offset", "cat={$cat}&limit=3&offset=0");
            if (!$post->getResult()):
